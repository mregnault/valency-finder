	...
	for n in range(0, len(json_load)):
		...
		if args.deptype == "std":
			...
			for key,value in json_load[n]['matching']['nodes'].items():
				if key == "NSUBJIMP" or "NSUBJ" or "CSUBJSINF" or "CSUBJSCOMPL" or "CLR" or "OBJSCOMPL" or "OBJSN" or "OBJSINF" or "IOBJDE" or "OBJAVINF" or "OBJASN" or "IOBJA" or "OBLSURSN" or "OBLSINF" or "OBLDESINF" or "OBJDESN" or "OBJDEVINF" or "OBLPARSN" or "OBLENSN" or "OBLDESN" or "OBLAVECSN" or "OBLCONTRESN" or "OBLASN" or "OBLASINF" or "CLY" or "DLOC":
					dep = key
					wlist.append(dep)
